...
where $l_{min}$ is the smallest size observed in any of the surveys, $r$ is a constant growth rate for small sizes, and $k(L_\infty^{0} - l)$ is the von Bertalanffy growth rate for larger sizes.
